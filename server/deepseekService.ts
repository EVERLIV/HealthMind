...
Отвечай ТОЛЬКО в формате JSON:
{
  ...
  "supplements": {
    ...
    "items": ["Перечисли КОНКРЕТНЫЕ добавки с ТОЧНЫМИ дозировками на основе данных пользователя (возраст, пол, биомаркеры, цели, заболевания). Например: 'Омега-3 1000мг 2 раза в день во время еды', 'Витамин D3 2000 МЕ утром', 'Магний цитрат 400мг перед сном', 'Коэнзим Q10 100мг утром с едой'"]
  },
