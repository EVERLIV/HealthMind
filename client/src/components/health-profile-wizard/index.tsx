...
const steps = [
  ...
  { id: 3, title: "Ментальное здоровье", shortTitle: "Ментальное Здоровье", icon: Brain, component: MentalHealthSection, color: "from-wellness-purple via-purple-500 to-purple-600", bgColor: "bg-gradient-to-br from-purple-100/8 via-purple-50 to-purple-100/50", iconBg: "bg-purple-500/15", iconColor: "text-purple-600" },
  { id: 4, title: "Образ жизни", shortTitle: "Образ Жизни", icon: Coffee, component: LifestyleSection, color: "from-energy-orange via-orange-500 to-orange-600", bgColor: "bg-gradient-to-br from-orange-100/8 via-orange-50 to-orange-100/50", iconBg: "bg-orange-500/15", iconColor: "text-orange-600" },
  ...
  { id: 7, title: "Медицинская история", shortTitle: "Медицинская История", icon: Heart, component: MedicalHistorySection, color: "from-red-500 via-red-500 to-rose-600", bgColor: "bg-gradient-to-br from-red-100/8 via-red-50 to-rose-100/50", iconBg: "bg-red-500/15", iconColor: "text-red-600" },
