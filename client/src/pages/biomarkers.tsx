                    ...
                    <>
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 leading-relaxed">
                            {(() => {
                              const biomarkerName = (selectedBiomarker as any)?.name;
                              const functions = {
                                'Гемоглобин': 'Переносит кислород от легких к тканям. Основа энергетического обмена в клетках.',
                                'Общий холестерин': 'Строительный материал для клеточных мембран и гормонов (тестостерон, эстроген, кортизол).',
                                'Глюкоза': 'Главный источник энергии для мозга и мышц. Регулируется инсулином поджелудочной железы.',
                                'Креатинин': 'Продукт распада мышечного креатина. Показатель фильтрационной способности почек.',
                                ...
                                'Тромбоциты': 'Клетки крови, отвечающие за свертываемость крови.',
                                'Эритроциты': 'Красные клетки крови, переносящие кислород и углекислый газ.'
                              };
                              return functions[biomarkerName as keyof typeof functions] || 'Важный показатель для оценки состояния здоровья';
                            })()}
                          </p>
                        </div>

                        <div>
                          <h3 className="font-semibold text-gray-900 mb-1">Признаки отклонений</h3>
                          <p className="text-sm text-gray-600 leading-relaxed">
                            {(() => {
                              const biomarkerName = (selectedBiomarker as any)?.name;
                              const symptoms = {
                                'Гемоглобин': 'При низком: слабость, одышка при нагрузке, бледность кожи, ломкость ногтей, странные пищевые пристрастия (лед, крахмал). При высоком: головные боли, головокружение, нарушения зрения.',
                                'Общий холестерин': 'При высоком: ксантомы (желтые пятна вокруг глаз), боли в ногах при ходьбе, стенокардия. При низком: депрессия, снижение либидо, нарушения пищеварения.',
                                'Глюкоза': 'При высокой: чрезмерная жажда, частое мочеиспускание, размытое зрение, медленное заживление ран. При низкой: дрожь, потливость, учащенное сердцебиение, раздражительность.',
                                'Креатинин': 'При высоком: отеки (особенно утром), изменение цвета мочи, усталость, тошнота, металлический привкус. При низком: потеря мышечной массы, слабость.',
                                'АЛТ': 'При повышении: усталость, тошнота, боль в правом подреберье, желтушность кожи и склер.',
                                'Лейкоциты': 'При повышении: лихорадка, слабость, частые инфекции. При снижении: частые простуды, медленное заживление ран.',
                                'Тромбоциты': 'При снижении: кровоточивость десен, синяки, петехии (точечные кровоизлияния). При повышении: головные боли, нарушения зрения.',
                                'Эритроциты': 'При снижении: слабость, одышка, бледность. При повышении: головокружение, головные боли, покраснение кожи.'
                              };
                              return symptoms[biomarkerName as keyof typeof symptoms] || 'Отклонения требуют консультации врача для правильной интерпретации';
                            })()}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 leading-relaxed">
                            {(() => {
                              const biomarkerName = (selectedBiomarker as any)?.name;
                              const supplements = {
                                'Гемоглобин': 'Железо (сульфат железа 325мг), Витамин C (1000мг) для усвоения железа, Фолиевая кислота (400мкг), Витамин B12 (1000мкг), Витамин B6 (50мг)',
                                'Общий холестерин': 'Омега-3 (2-3г EPA/DHA), Красный дрожжевой рис (600мг), Коэнзим Q10 (100мг), Берберин (500мг 3 раза), Ниацин (500мг), Растворимая клетчатка (10г)',
                                'Глюкоза': 'Хром пиколинат (200мкг), Альфа-липоевая кислота (300мг), Корица (500мг), Берберин (500мг 3 раза), Магний (400мг), Витамин D3 (2000 МЕ)',
                                'Креатинин': 'При высоком: избегать креатин и НПВП. Корень одуванчика (500мг), Листья крапивы (300мг), Клюква (36мг PAC), Кверцетин (500мг)',
                                'АЛТ': 'Расторопша (150мг силимарина), N-ацетилцистеин (600мг), Витамин E (400 МЕ), Селен (200мкг), Куркумин (500мг)',
                                'Лейкоциты': 'Витамин C (1000мг), Цинк (15мг), Витамин D3 (2000 МЕ), Эхинацея (300мг), Бета-глюкан (250мг)',
                                'Тромбоциты': 'При низких: Витамин B12 (1000мкг), Фолиевая кислота (800мкг), Железо (при дефиците). При высоких: Омега-3 (2г), Витамин E (400 МЕ)',
                                'Эритроциты': 'Железо (при дефиците), Витамин B12 (1000мкг), Фолиевая кислота (400мкг), Витамин B6 (50мг), Эритропоэтин (только по назначению врача)'
                              };
                              return supplements[biomarkerName as keyof typeof supplements] || 'Консультация с врачом по поводу дополнительных препаратов';
                            })()}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 leading-relaxed">
                            {(() => {
                              const biomarkerName = (selectedBiomarker as any)?.name;
                              const foods = {
                                'Гемоглобин': 'Говядина, печень теленка, моллюски (устрицы, мидии), тунец, темная фасоль, шпинат, тыквенные семечки, темный шоколад, киноа, сухофрукты (курага, изюм)',
                                'Общий холестерин': 'Овсянка, ячмень, бобовые (чечевица, нут), яблоки, авокадо, жирная рыба (лосось, скумбрия), грецкие орехи, оливковое масло, брюссельская капуста',
                                'Глюкоза': 'Листовая зелень (шпинат, кале), брокколи, авокадо, ягоды (черника, клубника), грецкие орехи, жирная рыба, цельные злаки (киноа, бурый рис), корица',
                                'Креатинин': 'При высоком: ограничить белок до 0.8г/кг веса, больше воды (2-3л), клюква, арбуз, огурцы, сельдерей. Избегать: красное мясо, субпродукты',
                                'АЛТ': 'Куркума, зеленый чай, грейпфрут, авокадо, жирная рыба, листовая зелень, свекла, артишоки. Избегать: алкоголь, жареное, обработанные продукты',
                                'Лейкоциты': 'Цитрусовые, красный перец, брокколи, чеснок, имбирь, миндаль, семечки подсолнуха, шпинат, йогурт с пробиотиками, зеленый чай',
                                'Тромбоциты': 'При низких: гранат, свекла, тыква, кунжут, темно-зеленые овощи. При высоких: помидоры, чеснок, темный виноград, ягоды годжи',
                                'Эритроциты': 'Красное мясо (умеренно), печень, темно-зеленые овощи, бобовые, сухофрукты, семена тыквы, морепродукты, обогащенные железом злаки'
                              };
                              return foods[biomarkerName as keyof typeof foods] || 'Сбалансированное питание с учетом возрастных потребностей';
                            })()}
                          </p>
                        </div>
